    ...
    <div class="content__inner">
        ...
        <form action="{{ route('mypage.profile') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="content__inner__avatar">
                <div class="content__inner__avatar__image">
                    <img src="{{ asset('storage/images/' . $user['avatar_path']) }}" id="preview" alt="" onerror="this.style.display='none'">
                </div>
                <button class="content__inner__avatar__button" type="button" id="select-file">画像を選択する</button>
